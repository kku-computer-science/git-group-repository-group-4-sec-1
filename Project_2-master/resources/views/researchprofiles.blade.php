                    ...
                    <div class="row text-center me-2">
                        <div class="col">
                            <div class="count" id='all'>
                                <h2 class="timer count-title count-number" data-to="{{ count($papers) }}" data-speed="1500"></h2>
                                <p class="count-text">SUMMARY</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="count" id='scopus_sum'>
                                <h2 class="timer count-title count-number" data-to="{{ count($papers_scopus) }}" data-speed="1500"></h2>
                                <p class="count-text">SCOPUS</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="count" id='wos_sum'>
                                <h2 class="timer count-title count-number" data-to="{{ count($papers_wos) }}" data-speed="1500"></h2>
                                <p class="count-text">WOS</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="count" id='tci_sum'>
                                <h2 class="timer count-title count-number" data-to="{{ count($papers_tci) }}" data-speed="1500"></h2>
                                <p class="count-text">TCI</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="count" id='google_sum'>
                                <h2 class="timer count-title count-number" data-to="{{ count($papers_google) }}" data-speed="1500"></h2>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="google_s" role="tabpanel" aria-labelledby="google_s-tab">
            <table id="example5" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    @foreach ($papers_google as $n => $paper)
                    <tr>
                        <td> {{$n+1}}</td>
                        <td>{{ $paper->paper_yearpub }}</td>
                        <!-- <td style="width:90%;">{{$paper->paper_name}}</td> -->
