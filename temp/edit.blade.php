...
<div class="container">
    {{-- <form action="{{ route('generate_pdf') }}" method="GET"> --}}
        ...
        <h3 style="padding-top: 10px; padding-bottom: 10px; text-align: center;">แก้ไข</h3>
        ...
        <button type="submit" name="download" value="1" class="btn btn-danger ">บันทึกการแก้ไข</button>
        <button type="submit" name="download" value="1" class="btn btn-danger ">บันทึกและเผยแพร่</button>
