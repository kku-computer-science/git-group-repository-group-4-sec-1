...
<div class="container">
    {{-- <form action="{{ route('generate_pdf') }}" method="GET"> --}}
        ...
        <button type="submit" name="download" value="1" class="btn btn-danger ">แก้ไข </button>
        <button type="submit" name="download" value="1" class="btn btn-danger ">เผยแพร่ </button>
